...
namespace QingCheng.AspNetCore.Authentication.Cookies
{
    /// <summary>
    ...
    public class CookieAuthenticationEvents
    {
        ...
        {
            if (request.Headers.TryGetValue(HeaderNames.ContentType, out var content))
            {
                if (content.ToString().Contains("json"))
                {
                    return true;
                }
            }
            ...
            {
                if (accept.ToString().Contains("json"))
                {
                    return true;
                }
            }
